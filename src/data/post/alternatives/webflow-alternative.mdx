...
5. **Import your content.** If you migrated a content-heavy site, load your exported CMS data into your new data layer — whether that is a headless CMS, a Postgres database, or a markdown-based content system.
