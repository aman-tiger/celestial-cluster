...
**Custom development is the right answer but the wrong economics.** Building a proper internal tool — authentication, permissions, audit logging, a clean UI — takes an experienced developer two to four weeks. At market rates, that's $10,000–$20,000 for something that will only ever be used by fifteen people.
